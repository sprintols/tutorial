...
API_HASH = "5bef6469ec162f7cc50c8f1c7a956159"

bot_token = "2034659360:AAGzG_u6j1DSpb51Ge-VUP0JYqWtbPZ0KMM"
...
async def MessagesManager(e):
	...
	if e.chat_id == ADMIN:
		if e.text == "/start":
			if SpamEnabled:
				await e.respond("**🤖 Spammer Bot v1.3 🤖**\n\n__ℹ️ Stato Spam »__ **Attivo ✅**\n\n__⚙ Developer »__ **@appacificarsi**", buttons=[[Button.inline("❌ Stoppa", "stop"), Button.inline("Spammer 📞", "voip")], [Button.inline("⏱ Tempo", "timer"), Button.inline("Messaggio 💬", "messaggio")], [Button.inline("👥 Entra nei Gruppi 👥", "join")]])
			else:
				await e.respond("**🤖 Spammer Bot v1.3 🤖**\n\n__ℹ️ Stato Spam »__ **Non Attivo ❌**\n\n__⚙ Developer »__ **@appacificarsi**", buttons=[[Button.inline("✅ Avvia", "start"), Button.inline("Spammer 📞", "voip")], [Button.inline("⏱ Tempo", "timer"), Button.inline("Messaggio 💬", "messaggio")], [Button.inline("👥 Entra nei Gruppi 👥", "join")]])
		elif Getter != None:
			if Getter == 0:
				Getter = None
	...
	if e.sender_id == ADMIN:
		if e.data == b"back":
			...
			if SpamEnabled:
				...
				await e.edit("**🤖 Spammer Bot v1.3 🤖**\n\n__ℹ️ Stato Spam »__ **Non Attivo ❌**\n\n__⚙ Developer »__ **@appacificarsi**", buttons=[[Button.inline("✅ Avvia", "stop"), Button.inline("Spammer 📞", "voip")], [Button.inline("⏱ Tempo", "timer"), Button.inline("Messaggio 💬", "messaggio")], [Button.inline("👥 Entra nei Gruppi 👥", "join")]])
		elif e.data == b"voip":
